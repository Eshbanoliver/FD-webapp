...
const llmsContent = `# FutureX Digital Marketing
...
- **Website**: https://futurexdigital.in
...
- **URL**: https://futurexdigital.in/services/search-engine-optimization
...
- **URLs**: 
  - https://futurexdigital.in/services/website-development
  - https://futurexdigital.in/services/webapp-development
...
- **URLs**:
  - https://futurexdigital.in/services/meta-ads
  - https://futurexdigital.in/services/google-ads
  - https://futurexdigital.in/services/pay-per-click
...
- **URLs**:
  - https://futurexdigital.in/services/social-media-management
  - https://futurexdigital.in/services/logo-design
  - https://futurexdigital.in/services/video-editing
  - https://futurexdigital.in/services/graphic-design
  - https://futurexdigital.in/services/content-writing

## Main Pages
- [Home](https://futurexdigital.in/) - Overview of agency offerings, client metrics, and growth solutions.
- [About Us](https://futurexdigital.in/about) - FutureX history, agency mission, team, and company values.
- [Services Master Index](https://futurexdigital.in/services) - Comprehensive list of digital services.
- [Portfolio Showcase](https://futurexdigital.in/portfolio) - Past client results, web dev case studies, and ad ROI metrics.
- [Blog & Industry Insights](https://futurexdigital.in/blog) - Digital marketing guides, SEO strategies, and growth tips.
- [Frequently Asked Questions (FAQ)](https://futurexdigital.in/faq) - Detailed answers regarding pricing, campaign setup, timeline, and deliverables.
- [Client Testimonials](https://futurexdigital.in/testimonials) - Verified reviews and success stories from business owners.
- [Contact Us](https://futurexdigital.in/contact) - Inquiry form, office location, map, and instant contact info.
`;
